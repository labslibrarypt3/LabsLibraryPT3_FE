...
const TOS = () => {
  return (
    <div>
      <h2>Welcome to Neighborhood Library</h2>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, Neighborhood Library and/or it's licensors own
        the intellectual property rights for all material on Neighborhood
        Library. All intellectual property rights are reserved. You may view
        and/or print pages from https://goofy-mayer-45bb20.netlify.com/ for your
        own personal use subject to restrictions set in these terms and
        conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from https://goofy-mayer-45bb20.netlify.com/</li>
        <li>
      ...
      <p>
        Redistribute content from Neighborhood Library (unless content is
      ...
      <h2>
        Paying and Processing Late Fees, Lost Book Fees, and Other Payment
        Transfers
      </h2>
      <p>
        Payment processing services for users on Neighborhood Library are
        provided by Stripe and are subject to the Stripe Connected Account
        Agreement, which includes the Stripe Terms of Service (collectively, the
        “Stripe Services Agreement”). By agreeing to these terms or continuing
        to operate as a user of Neighborhood Library, you agree to be bound by
        the Stripe Services Agreement, as the same may be modified by Stripe
        from time to time. As a condition of Neighborhood Library enabling
        payment processing services through Stripe, you agree to provide
        Neighborhood Library accurate and complete information about you and
        your business, and you authorize Neighborhood Library to share it and
